...
import { BookOpen, Trophy, Target, Clock, TrendingUp, Users, FileText, CheckCircle } from 'lucide-react';
                        ...
                        <div key={submission.id} className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
                          ...
                          <div className="flex items-center gap-2">
                            {submission.evaluated_at ? (
                              <span className="text-sm px-2 py-1 rounded bg-success/10 text-success">
                                Avaliado: {submission.score}%
                              </span>
                            ) : (
                              <span className="text-sm px-2 py-1 rounded bg-warning/10 text-warning">
                                Pendente
                              </span>
                            )}
                          </div>
